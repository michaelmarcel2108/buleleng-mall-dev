  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <div className="font-display text-lg font-medium line-clamp-1">{product.name}</div>
        {product.businesses && <div className="text-sm text-gray-500 line-clamp-1">{product.businesses.name}</div>}

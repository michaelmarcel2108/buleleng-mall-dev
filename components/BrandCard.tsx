...
const BrandCard = ({ business }: BrandCardProps) => {
  ...
  return (
    <Link 
      ...
      className="w-full flex flex-col gap-1 rounded-lg p-2 md:p-4 hover:bg-gray-100 transition-colors cursor-pointer bg-white outline-none border-none ring-0 shadow-sm block"
    >

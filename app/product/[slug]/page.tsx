  ...
  if (error || !products || products.length === 0) {
    return (
      <div className="p-16 text-center min-h-[60vh] flex flex-col items-center justify-center gap-4 bg-gray-50/50">
        ...
        <Link href="/catalog" className="bg-blue-900 px-6 py-2 rounded-full hover:opacity-90 transition-all font-medium text-white">
          Kembali ke Katalog
        </Link>
      </div>
    );
      ...
      <section className="max-w-5xl mx-auto mt-12 md:mt-20 w-full relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {catalogProducts && catalogProducts.length > 0 ? (
            ...
            <p className="text-gray-500 col-span-full py-4 text-center">Belum ada produk lain saat ini.</p>
          )}
        </div>

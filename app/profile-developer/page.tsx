...
export const metadata = {
  title: "Tim Pengembang | Buleleng Mall",
  description: "Profil tim pengembang platform Buleleng Mall",
};
  ...
  return (
    <main className="min-h-screen bg-gray-50 font-sans">
      ...
      <section className="max-w-5xl mx-auto px-6 md:px-16 pt-6 md:pt-10">
        <div className="w-full relative aspect-square md:aspect-[21/21] rounded-xl overflow-hidden shadow-sm bg-gray-200">
          <Image
